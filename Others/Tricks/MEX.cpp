...
: we can find MEX using segment tree also via using similar concept by keeping count of number of elements in O(logn).
: We can find the mex in O(logn * logn) using Binary search and BIT.
*/